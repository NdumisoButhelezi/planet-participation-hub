    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 text-center">
        <div data-aos="zoom-in" className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-500 text-transparent bg-clip-text">
            Ready to Start Your AI Journey?
          </h2>
          <p className="text-lg text-gray-700 mb-8">
            Join thousands of learners who are advancing their careers with Planet 09 AI
          </p>
          <Button 
