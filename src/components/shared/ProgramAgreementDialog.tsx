    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto animate-in fade-in-0 zoom-in-95 duration-300">
        <DialogHeader className="space-y-4">
          <DialogTitle className="text-2xl font-playfair">PlutoDev Participation Agreement</DialogTitle>
          <DialogDescription>
            <div className="prose prose-lg mt-4 space-y-6 text-gray-700">
              ...
              <p className="font-medium text-lg">🎯 Goal: Enhance students' coding skills through hands-on projects, workshops, hackathons, and expert guest sessions.</p>
              
              <div className="space-y-6">
                <h3 className="text-lg font-playfair text-purple-600">🔹 Participant Commitments</h3>
                <div className="pl-4">
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                <h3 className="text-lg font-playfair text-purple-600">🔹 Program Compliance</h3>
        ...
        <DialogFooter>
          <Button 
            ...
            className="w-full mt-4 bg-purple-600 hover:bg-purple-700 transition-colors duration-300"
          >
            Close
          </Button>
        </DialogFooter>
